...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var lottieProvider = Lottie.asset("images/anima_tik.json",height: 2,width: 2);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Welcome To Exchange Raviar!',
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                ...
                                if(value.endsWith('@gmail.com')){
                                  Lottie.asset('images/anima_tik.json');
                                }
                                return 'please enter valid gmail';
                              }
                              return null;
  ...
  Future <void> savedLogin(UserModel model1) async {
    final prefs = await SharedPreferences.getInstance();

    prefs.setString("user_token", model1.token!);
